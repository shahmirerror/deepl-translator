            ...
            <div class="row">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <div
                        ...
                        <h1 class="h2">Settings <?php if(isset($_GET['page'])){ echo '- ',$_GET['page']; }?></h1>
                        <a href="./settings.php" type="button" class="btn btn-md btn-danger">Go Back</a>
                    </div>
                    <?php
                    ...
                    ?>
                    <?php if(isset($_GET['page'])){ if($_GET['page'] == 'API Key'){ ?>
                        <?php   $target_dir = 'includes/settings/api_key.txt';
                    ...
                    <form class="form-floating" action="./backend/settings.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <input type="text" name="apiKey" id="apiKey" class="form-control" value="<?php echo $line; ?>" placeholder="Enter your API key here" />
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <?php }elseif($_GET['page'] == 'Exclusions'){ ?>
                        <?php   $target_dir = 'includes/settings/exclusions.txt';
                                $fp = fopen($target_dir, 'r');
                                $line = '';
                                while (!feof($fp)) {
                                    $line = fgets($fp);
                    ...
                    <?php }elseif($_GET['page'] == 'Languages'){ ?>
                    ...
                    <form class="form-floating" action="./backend/settings.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea name="langs" id="langs" class="form-control"><?php echo $line; ?></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 mt-3">
                    ...
                    <?php }elseif($_GET['page'] == 'Top Languages'){ ?>
                        <?php   $target_dir = 'includes/settings/languages.txt';
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a href="./settings.php?page=API Key" type="button" class="btn btn-lg btn-info text-white">API Key</a>
                        </div>
                        <div class="col-md-3">
                            <a href="./settings.php?page=Exclusions" type="button" class="btn btn-lg btn-info text-white">Exclusions</a>
                        </div>
                        <div class="col-md-3">
                            <a href="./settings.php?page=Languages" type="button" class="btn btn-lg btn-info text-white">Languages</a>
                        </div>
                        <div class="col-md-3">
                            <a href="./settings.php?page=Top Languages" type="button" class="btn btn-lg btn-info text-white">Top Languages</a>
                        </div>
                    </div>
                    <?php } ?>
                </main>
